...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update action" do
    ...
    it "should render the edit form with an http status of unprocessable_entity when editing message to an empty string" do
      gram = FactoryGirl.create(:gram, message: 'Initial Value')
      sign_in gram.user
    ...
    it "shouldn't let userse who didn't create the gram to update it" do
      p = FactoryGirl.create(:gram)
      u = FactoryGirl.create(:user)
      sign_in u
  ...
  describe "gram#destroy action" do
    ...
    it "should erturn a 404 message if we cannot find a gram with the specified id" do
      u = FactoryGirl.create(:user)
      sign_in u
